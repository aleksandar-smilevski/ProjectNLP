...
def load_data_and_labels():
    ...
    pos_path = urllib2.urlopen('https://raw.githubusercontent.com/yoonkim/CNN_sentence/master/rt-polarity.pos')

    # Pull sentences with negative sentiment
    neg_path = urllib2.urlopen('https://raw.githubusercontent.com/yoonkim/CNN_sentence/master/rt-polarity.neg')
    # pos_path = "./data/rt-polaritydata/rt-polarity.pos"
    # neg_path = "./data/rt-polaritydata/rt-polarity.neg"
    positive_examples = list(pos_path.readlines())
    positive_examples = [s.strip() for s in positive_examples]
    negative_examples = list(neg_path.readlines())
